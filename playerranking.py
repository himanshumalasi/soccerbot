...
allplayers=[]
l=[]
body1=soup.findAll('h2',{'class':'listItem listItem__h2 listItem__h2--grid listItem__h2--popUp pointer listItem__h2--buyButton listItem--topBorder flex relative robotoC'})
...
try:
    ...
    l.append(body1[0].findAll('a',{'class':'listItem__title listItem__title--link black $tkl'})[0].text)
except:
    pass
try:
...
body=soup.findAll('h2',{'class':'listItem listItem__h2 listItem__h2--grid listItem__h2--popUp pointer listItem__h2--buyButton flex relative robotoC'})
...
for i in range(len(body)):
	try:
		...
		l.append(body[i].findAll('a',{'class':'listItem__title listItem__title--link black $tkl'})[0].text)
